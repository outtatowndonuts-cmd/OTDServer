...
const currentPage = (() => {
  const p = window.location.pathname.replace('/shop', '').replace(/^\//, '');
  return p || 'home';
})();
...
function Layout({ children }) {
  ...
  // Initialise Google Analytics if a GA ID meta tag was injected by the server
  useEffect(() => {
    ...
    <>
        ...
        <div className="container">
          <div className="otd-nav-inner">
            ...
            <div className="otd-nav-links">
              <a className={`otd-nav-link${currentPage === 'home' ? ' active' : ''}`} href="/shop">
                Home
              </a>
              ...
              <a className={`otd-nav-link${currentPage === 'contact' ? ' active' : ''}`} href="/shop/contact">
                Contact
              </a>
            </div>
          </div>
      ...
      <footer className="otd-footer">
        <div className="container">
          ...
          <div className="otd-footer-bottom">
            <span>&copy; {new Date().getFullYear()} Outta Town Donuts &mdash; A New Weird America project.</span>
            <a className="otd-admin-link" href="/apply">
              Administration
            </a>
          </div>
        </div>
