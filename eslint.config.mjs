...
export default [
  ...
  {
    ignores: ['tmp/**', 'tmp', 'modules/pos/client/**', 'modules/pos/public/**', 'modules/admin/client/**', 'modules/admin/public/**', 'modules/commerce/public/**', 'modules/special-orders/client/**', 'modules/special-orders/public/**'],
